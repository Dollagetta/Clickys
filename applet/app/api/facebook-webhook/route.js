...
export async function POST(req) {
  try {
    ...
    // Process synchronously instead of using `after` to ensure Vercel doesn't kill the task prematurely
    try {
    ...
    return NextResponse.json({ message: 'Webhook received and processed completely' }, { status: 200 });
